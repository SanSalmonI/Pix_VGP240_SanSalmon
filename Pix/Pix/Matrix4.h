...
struct Matrix4
{
    ...
    //    (delegates to the 4x4 identity constructor below)
    //
    Matrix4()
    ...
    //
    // 2) Custom constructor with individual float values for each element
    //
    ...
    //
    // 3) Static function: return an identity matrix
    //
    ...
    //
    // 4) Static rotation methods: X, Y, Z
    //
